  ...
  return (
    <div className={styles.page}>
      <header className={styles.hero}>
        <div>
          <p className={styles.eyebrow}>MeliInsights · AI-Powered Analytics</p>
          <h1>Publicaciones de Mercado Libre</h1>
          <p className={styles.subtitle}>
            Importa desde ML, analiza con IA y optimiza tus ventas. Conecta tu cuenta, importa
            publicaciones y obtén recomendaciones inteligentes para mejorar tu negocio.
          </p>
